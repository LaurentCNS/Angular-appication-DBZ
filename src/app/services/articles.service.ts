...
export class ArticlesService {
  ...
  articles : Article[]=  [
    ...
    new Article(0, `Akira toriyama`, `10 mai 2022`, `Cela peut paraître étrange, mais alors que Dragon Ball est intimement lié à Akira Toriyama, l'auteur a toujours...`, `Même si vous n'avez jamais lu un manga, vous avez sûrement déjà entendu parler de Dragon Ball. Cette bande dessinée
    ...
    new Article(1, `Mais ou est Lunch?`, `11 mai 2022`, `La dernière apparition de Lunch se fit au chapitre 194 (en 1988) où Goku a battu Piccolo. Au chapitre 196, Lunch...`, `En 2003, lors d’un passage à New-York pour la version américaine du Shonen jump, une question est posée à Toriyama :
    ...
    new Article(2, `Restaurant DBZ au japon`, `11 mai 2022`, `C’est à Osaka que le lieu vient d’être inauguré et on y baigne naturellement dans l’univers de Dragon Ball et...`, `Depuis un mois déjà, les fans de manga au Japon peuvent profiter de l’ouverture d’un restaurant dédié à Dragon Ball Z.
    ...
    new Article(3, `Easter Egg Batman`, `12 mai 2022`, `La référence à Batman n’a pas été découverte pendant près de 32 ans...`, `Dragon Ball Z est truffé de petits Easter Eggs. Cependant, un détail particulier dans l’arrière-plan d’un ancien épisode
    ...
    new Article(4, `Attraction DBZ`, `13 mai 2022`, `La franchise Universal Studios s’apprête à rendre hommage à ...`, `La franchise Universal Studio met de plus en plus en avant ses animations en rapport avec les licences de grands mangas
    ...
    new Article(5, `Triste nouvelle 😢`, `14 mai 2022`, `Une triste nouvelle pour tous les fans du Club Dorothée.Ariane Carletti, qui était...`, `Une triste nouvelle pour tous les fans du Club Dorothée. Ariane Carletti, qui était aussi l’interprète des génériques de 
